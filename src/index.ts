...
import { handlerAddFeed, handlerFollowFeed, handlerFollowList, handlerListFeeds } from "./commands/feeds";
...
async function main() {
  ...
  registerCommand(registery, "follow", handlerFollowFeed);
  registerCommand(registery, "following", handlerFollowList);
